...
import { getCleanupAreaLabel, getCleanupMetricMeta } from "./constants";
      ...
      {cleanupRecords.length === 0 ? (
        ...
        <div className="space-y-2">
          {cleanupRecords.map((record) => {
            ...
            const metricMeta = record.metric
              ? getCleanupMetricMeta(record.metric.type)
              : null;
