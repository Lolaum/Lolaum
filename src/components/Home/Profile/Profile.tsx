  ...
  return (
    <>
      {showEditModal && (
        ...
        >
          <div
            className="bg-white rounded-3xl shadow-xl p-6 mx-4 w-full max-w-sm"
          ...
          >
            ...
            <div className="flex justify-center mb-5">
              <div className="relative">
                ...
                <label
                  className="absolute -bottom-0.5 -right-0.5 w-6 h-6 rounded-full flex items-center justify-center shadow-sm cursor-pointer"
        ...
        <div>
          <div className="flex justify-between items-center mb-1.5">
            ...
            <span className="text-xs font-semibold text-gray-500">
              {completionRate?.totalAchieved ?? 0}/
