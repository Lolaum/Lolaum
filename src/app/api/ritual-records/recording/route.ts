...
import type { Json, RecordingRecordData } from "@/types/supabase";

// GET /api/ritual-records/recording?challengeId=xxx&date=2026-04-03
...
// POST /api/ritual-records/recording
export async function POST(request: NextRequest) {
  ...
  const { challengeId, recordDate, recordData } = body as {
    challengeId: string;
    recordDate: string;
    recordData: RecordingRecordData;
  };
